import { generateInvoices } from "./generate-invoices.helper";
import { InvoiceBuilder } from "../models/builders/invoice.builder";
import { on } from "@toolbox/helpers";

describe('GenerateInvoicesHelper', () => {

  it('should generate invoices', () => {
    const invoices = generateInvoices({name: 'Stubby Company', workDaysCount: 20, dailyRate: 500, count: 2, begin: on('01/12/2022')})
